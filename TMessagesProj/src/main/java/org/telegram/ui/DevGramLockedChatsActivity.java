...
public class DevGramLockedChatsActivity extends BaseFragment {
    ...
    private void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        items.add(UItem.asHeader(LocaleController.getString(R.string.DevGramLockedChatsPasscode)));
        items.add(UItem.asButton(ID_SET_PASSCODE, hasPass
        ...
        if (hasPass) {
            items.add(UItem.asButton(ID_REMOVE_PASSCODE, LocaleController.getString(R.string.DevGramLockedChatsRemovePasscode)).red());
        }
        ...
        items.add(UItem.asHeader(LocaleController.getString(R.string.DevGramLockedChatsList)));
